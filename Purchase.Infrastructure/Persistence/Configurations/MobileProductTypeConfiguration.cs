...
{
    public class MobileProductTypeConfiguration : IEntityTypeConfiguration<MobileProductType>
    {
        public void Configure(EntityTypeBuilder<MobileProductType> builder)
        {
